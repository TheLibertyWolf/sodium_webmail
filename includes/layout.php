        ...
        <div class="modal fade" id="aboutModal" tabindex="-1" aria-labelledby="aboutModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog modal-lg modal-dialog-scrollable"><div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex align-items-center gap-3 mb-4"><span class="brand-mark flex-shrink-0">M</span><div><strong class="d-block fs-5">Sodium</strong><span class="text-muted">Webmail professionnel privé</span></div><span class="badge text-bg-danger ms-auto">Version 0.11.0 bêta</span></div>
                ...
                <div class="modal-footer"><span class="text-muted small me-auto">Sodium 0.11.0 bêta</span><button class="btn btn-danger" type="button" data-bs-dismiss="modal">Fermer</button></div>
            </div></div>
        </div>
