...
require_once __DIR__.'/includes/platform/functions.php';require_once __DIR__.'/includes/i18n.php';require_once __DIR__.'/includes/platform/mail-lib.php';require_once __DIR__.'/includes/sodium.php';sodium_ensure_schema();
