...
<div class="col-md-6"><label class="form-label">Début</label><input class="form-control" type="datetime-local" name="starts_at" value="<?=!empty($rule['starts_at'])?e(date('Y-m-d\\TH:i',strtotime((string)$rule['starts_at']))):''?>"></div><div class="col-md-6"><label class="form-label">Fin</label><input class="form-control" type="datetime-local" name="ends_at" value="<?=!empty($rule['ends_at'])?e(date('Y-m-d\\TH:i',strtotime((string)$rule['ends_at']))):''?>"></div>
