...
<div class="row g-4">
    <div class="col-12"><div class="table-card"><div class="p-4 border-bottom"><div class="d-flex align-items-center gap-3"><span class="brand-mark">M</span><div><h2 class="h4 mb-1">Licence Sodium Webmail</h2><p class="text-muted mb-0">Activation et contrôle du droit d’exploitation de cette instance.</p></div></div></div><div class="p-4">
        ...
        <div class="license-protection-notice mt-4"><i class="bi bi-shield-lock-fill"></i><div><strong>Protection du logiciel et preuve d’antériorité</strong><p class="mb-0">Sodium Webmail, son code source, son architecture, ses interfaces, sa documentation et ses éléments originaux sont protégés par le droit d’auteur ainsi que par les dispositions françaises, européennes et internationales applicables à la propriété intellectuelle et aux logiciels. Dès la mise en ligne de la version 1.0, ses éléments constitutifs et leur antériorité ont fait l’objet d’un constat probatoire dressé par commissaire de justice. Ce constat contribue à établir la date, l’existence et l’intégrité des éléments constatés, sans se substituer aux droits qui naissent de leur création.</p></div></div>
    </div></div></div>
