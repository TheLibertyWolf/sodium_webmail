        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable"><div class="modal-content"><form method="post" class="sodium-aptitudes-form">
            ...
            <div class="modal-body">
                ...
                <div class="row g-3 mb-4 aptitude-module-grid">
                    ...
                    <div class="col-md-6"><div class="aptitude-module-card <?= $hasFullAccess?'is-disabled':'' ?>"><div class="aptitude-module-heading"><span class="aptitude-card-icon"><i class="bi bi-cloud-arrow-down"></i></span><strong>Mises à jour</strong></div><div class="aptitude-module-rights"><label class="form-check mb-0" title="Contrôler et installer les nouvelles versions de Sodium"><input class="form-check-input module-aptitude" type="checkbox" name="aptitudes[sodium_update]" value="1" <?= in_array('sodium_update',$userAptitudes,true)?'checked':'' ?> <?= $hasFullAccess?'disabled':'' ?>><span class="form-check-label">Mettre à jour</span></label></div></div></div>
                    <?php foreach ([
                        ...
                        'Paramètres généraux'=>['bi-sliders','sodium_general_settings_view','sodium_general_settings_manage',''],
                        'Paramètres de sécurité'=>['bi-shield-lock','sodium_security_settings_view','sodium_security_settings_manage',''],
